...
<html class="no-js" lang="en" dir="ltr">
	...
	<body>
		...
		?>
		<a class="success button expanded" href="unos.php">Unos Nove Šetnje</a>
		<div class="row">
			<div class="large-12 ">
   	...
   	<div class="row">
		<?php 
		$izraz=$veza->prepare("select * from usluga_setanja_psa where vrsta like :uvjet order by sifra desc");
