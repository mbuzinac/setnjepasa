...
if(isset($_POST["dodaj"])){
	...
	if(count($poruke)==0){
		//radi insert
		unset($_POST["dodaj"]);
		$izraz=$veza->prepare("insert into setac 
		(ime,prezime,mjesto,email,telefon,ziro_racun,lozinka) values 
		(:ime,:prezime,:mjesto,:email,:telefon,:ziro_racun,:lozinka)");
		$izraz->execute($_POST);
	...
	<body>
		...
		<form action="<?php echo $_SERVER["PHP_SELF"] ?>" 
			...
			<fieldset class="fieldset">
				...
				inputPolje("number","ziro racun",$poruke);
