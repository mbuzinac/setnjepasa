...
<html class="no-js" lang="en" dir="ltr">
	...
	<body>
		...
		?>
		<a class="success button expanded" href="unos.php">Unos Vlasnika</a>
		<div class="row">
			<div class="large-12 ">
   	...
   	<div class="row">
		<?php 
		$izraz=$veza->prepare("select * from vlasnik_psa where ime like :uvjet order by sifra desc");
